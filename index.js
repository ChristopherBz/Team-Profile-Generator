...
const render = require("./JS/basepagerender");

// Inquirer Questions for team member development and to create objects for each team member.
const teamMembers = [];
...
function addTeamMember() {
    inquirer.prompt([{
        ...
        choices: ["Engineer", "Intern", "No more to add - Finish"]
    }]).then(val => {
